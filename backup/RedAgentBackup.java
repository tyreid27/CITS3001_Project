...
public class RedAgent {
    ...
    public void redTurn(GreenAgent[] greenTeam) {
        ...
        for (int i = 0; i < greenTeam.length; i++) {
            ...
            double lostFollowerProbability = GameLibrary.loseFollowerProbability(currentUncertainty, messagePotency);
            //System.out.println(lostFollowerProbability);
            //System.out.println("\n");
            boolean lostFollower = rand.nextInt(1,101) <= lostFollowerProbability;
            //System.out.println("has lost follower: " + lostFollower);
